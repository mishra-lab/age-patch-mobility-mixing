...
% JK: @SM I added in the acknowledgements in meta.tex (same as serial interval paper)  SM: - yes works there
...
%     but not sure if there is an earlier version we were working from instead?  SM: if you used Brown et al Science Table report to generate the deciles, then these are not the dates (the Brown et al report was published in February 2021). If you used the decile-FSA mapping from ICES dashboard, then it was based on 15 January 2020 to 28 March 2021.
