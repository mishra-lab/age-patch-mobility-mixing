...
%     and added a little but more detail to the abstract here with the available room.
% SM: got it! reads well
...
% SM: we don't do SARS modeling here, so maybe frame as application to generate parameters...
We also provide methods for deriving the mobility matrix based on GPS mobility data (appendix).
% SM: define GPS or spell it out in full here since not using acronym again in abstract?
% JK: I actually think that "GPS" is more semantically recognizable than spelling it out
