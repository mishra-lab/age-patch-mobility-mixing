...
\begin{enumerate}
  ...
  % JK: Reflecting on it, I personally perceive these words as interchangeable regarding mixing,
  ...
  % JK: hopefully the revisions & example now flow better?
...
% JK: :) "it was easy". Narrator: it was not.
