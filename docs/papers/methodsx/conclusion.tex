...
% JK: @SM this next sentence added from suggestion in method.tex & also based on the comment below
...
% JK: @SM Hmm, do you mean different numbers of contacts formed per-person for each patch?
...
%     But I did add an extra comment about different contact numbers by patch  %SM: yes its like population size by age-group and number of contacts by age group. if there are  more factory workers in patch A vs. patch 2, then would  need to balance that too. your edit captures that nicely
