...
% SM: yes its like population size by age-group and number of contacts by age group.
%     if there are more factory workers in patch A vs. patch 2, then would  need to balance that too.
%     your edit captures that nicely
