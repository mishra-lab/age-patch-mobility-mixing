...
showing the time trend (\subref{fig:Bc-gt})
...
\begin{figure}[bt]
  \begin{subfigure}{\linewidth}
    \includegraphics[width=\linewidth]{Bc-gt}
...
\begin{figure}[ht]
  ...
  \floatfoot{Derived from mobile device geolocation data;
    deciles represent groupings of Ontario forward sortation areas (FSAs)
    by cumulative \covid cases between 15 Jan 2020--28 Mar 2021;
    x-y scales are log\textsubscript{10} transformed to improve perception of smaller values}
\end{figure}
\clearpage
% ==================================================================================================
