...
% JK: I guess it kind of includes both issues
...
\begin{figure}[ht]
  ...
  \caption{Mixing implications for two assumptions about
    ...
    % JK: Hmm, I would say the three situations from 2.2.2 all pertain to
...
% JK: big re-writes to this section to reflect the latest data from AG
...
% JK: this section completely new -- and possibly out of scope,
